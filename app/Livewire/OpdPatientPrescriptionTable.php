        ...
        return $table
            ...
            ->headerActions([
                Actions\CreateAction::make()
                    ->visible(fn () => hasModulePermission('OPD Prescriptions', 'create'))
                    ->modalWidth('7xl')
                    ->createAnother(false)
            ...
            ->actions([
                ...
                Actions\EditAction::make()
                    ->modalWidth('7xl')
                    ->iconButton()
                    ->visible(fn () => hasModulePermission('OPD Prescriptions', 'edit'))
                ...
                Actions\DeleteAction::make()
                    ->iconButton()
                    ->visible(fn () => hasModulePermission('OPD Prescriptions', 'delete'))
