...
class PharmacistPayrollRelationTable extends Component implements HasForms, HasTable
{
    ...
    public function GetRecord()
    {
        ...
        $pharmacists = Pharmacist::with('payrolls')->where('id', $id)->get();

        foreach ($pharmacists as $item) {
    ...
    {
        return view('livewire.pharmacist-payroll-relation-table');
    }
}
