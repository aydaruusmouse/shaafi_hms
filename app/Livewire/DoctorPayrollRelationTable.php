...
class DoctorPayrollRelationTable extends Component implements HasForms, HasTable
{
    ...
    public function GetRecord()
    {
        ...
        $accountants = Doctor::with('payrolls')->where('id', $id)->get();
        ...
        $payrolls = EmployeePayroll::whereIn('payroll_id', $payrollIds)->orderByDesc('id');
    ...
    {
        return view('livewire.doctor-payroll-relation-table');
    }
}
