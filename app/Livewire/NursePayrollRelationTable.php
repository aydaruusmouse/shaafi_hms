...
class NursePayrollRelationTable extends Component implements HasForms, HasTable
{
    ...
    public function GetRecord()
    {
        ...
        $nurses = Nurse::with('payrolls')->where('id', $id)->get();
    ...
    {
        return view('livewire.nurse-payroll-relation-table');
    }
}
