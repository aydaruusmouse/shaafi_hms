                    ...
                    <td class="desc vertical-align-top bg-light">
                        <div class="col-md-4 co-12 mt-md-0 mt-5">
                            @if (empty($prescription['prescription']->doctor->address->address1) &&
                                    ...
                                    {{ __('messages.common.address') . ':' . ' ' . 'N/A' }}
                        ...
                        <div class="">
                            <p class="text-gray-600 me-1">
                                {{ __('messages.user.phone') }}:
                                <span class="fs-5 text-gray-800 w-100">
                                    {{ !empty($prescription['prescription']->doctor->user->phone) ? $prescription['prescription']->doctor->user->region_code . $prescription['prescription']->doctor->user->phone : 'N/A' }}
                                </span>
                            </p>        
                            ...
                            <p class="text-gray-600 me-1">
                                ...
                                <span class="fs-5 text-gray-800 w-100">
                                    {{ !empty($prescription['prescription']->doctor->user->email) ? $prescription['prescription']->doctor->user->email : 'N/A' }}
                                </span>
                            </p>
                        </div>
                    </td>
