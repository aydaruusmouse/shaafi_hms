                        ...
                        <td class="desc vertical-align-top bg-light">
                            <table class="table w-100">
                                ...
                                <tr class="lh-2">
                                    <td class="">
                                        <label for="name"
                                            class="pb-2 fs-5 font-weight-bold me-1">{{ __('messages.patient_diagnosis_test.patient_name') }}:</label>
                                    </td>
                        ...
                        <tbody>
                            @if (isset($patientDiagnosisTests))
                                @foreach ($patientDiagnosisTests as $key => $patientDiagnosisTest)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ !empty($patientDiagnosisTest->property_name) ? str_replace('_', ' ', Str::title($patientDiagnosisTest->property_name)) : 'N/A' }}
                                        </td>
