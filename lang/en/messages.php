...
return [
    ...
    'doctor_suggested_tests' => 'Doctor Suggested Tests',
    'lab_report_payments' => 'Lab Report Payments',
    'radiology_report_payments' => 'Radiology Report Payments',
    'doctor_suggested_radiology_tests' => 'Doctor Suggested Radiology Tests',
    'section' => 'Section',
    'proceed' => 'Proceed',
    'pay' => 'Pay',
    'create_pathology_test_from_suggestion' => 'Create Pathology Test from Doctor Suggestions',
    'create_radiology_test_from_suggestion' => 'Create Radiology Test from Doctor Suggestions',
    'expenses' => 'Expenses',
    'income' => 'Income',
    'finance' => 'Finance',
    ...
    'common' => [
        ...
        'action' => 'Action',
        'save' => 'Save',
        'save_and_make_appointment' => 'Save & Make Appointment',
        'cancel' => 'Cancel',
        'canceled' => 'Canceled',
        'confirm' => 'Confirm',
        'back' => 'Back',
        ...
        'no_doctor_suggested_tests_description' => 'No doctor suggested tests found.',
        'no_paid_doctor_suggested_tests_description' => 'No paid doctor suggested tests found. Collect payment from Lab Report Payments first.',
        'no_paid_doctor_suggested_radiology_tests_description' => 'No paid doctor suggested radiology tests found. Collect payment from Radiology Report Payments first.',
    ...
    'appointment' => [
        ...
        'ticket_count' => 'Daily Ticket Count',
        'ticket' => 'Ticket',
        'ticket_n' => 'Ticket :number',
        'select_ticket' => 'Please select a ticket.',
        'ticket_taken' => 'This ticket has already been taken. Please select another available ticket.',
        'ticket_board' => 'Daily Ticket Board',
        'ticket_available' => 'Available',
        'ticket_reserved' => 'Reserved',
        'ticket_taken_status' => 'Taken',
        'ticket_cancelled' => 'Cancelled',
        'select_doctor_and_date_for_tickets' => 'Select a doctor and date to view available tickets.',
        'ticket_capacity_below_booked' => 'Daily ticket count cannot be reduced below :min because higher-number tickets are already booked today.',
        'appointment_details' => 'Appointment Details',
        ...
        'create_patient_and_appointment' => 'Create Patient & Make Appointment',
        'in_vital' => 'In Vital',
        'check_in' => 'Check In',
        'assign_vital' => 'Assign Vital',
        'moved_to_vital' => 'Appointment moved to vital signs successfully.',
        ...
        'random_blood_sugar' => 'Random Blood Sugar (mg/dl)',
        'fasting_blood_sugar' => 'Fasting Blood Sugar (mg/dl)',
        'drug_allergies' => 'Drug Allergies',
        'vital_signs_saved' => 'Vital signs saved.',
        'no_vital_appointments' => 'No appointments in vital signs',
        'no_vital_appointments_desc' => 'New appointments and patients sent from the queue appear here so you can record vital signs.',
        'pending_vitals' => 'Pending',
        'recorded_vitals' => 'Recorded',
        'send_to_queue' => 'Send to Queue',
        'sent_to_queue' => 'Patient sent to queue.',
        'record_vitals_before_check_in' => 'Record vital signs first. The patient was moved to Vital Signs.',
        'checked_in_to_opd' => 'Patient checked in and moved to OPD successfully.',
    ...
    'dashboard' => [
        ...
        'hospital_census' => 'Hospital Census',
        'today_appointments' => "Today's Appointments",
        'today_opd' => "Today's OPD",
        'today_ipd' => "Today's IPD Admissions",
        ...
        'activity_last_7_days' => 'Hospital Activity (Last 7 Days)',
        'ipd_vs_opd' => 'IPD vs OPD',
        'active_inpatients' => 'Active Inpatients',
        'pending_pathology' => 'Pending Pathology Tests',
    ...
    'radiology_test' => [
        ...
        'charge_category' => 'Charge Category',
        'standard_charge' => 'Standard Charge',
        'test_results_document' => 'Test Results Document',
        'test_results_document_description' => 'Upload PDF or Word document with test results',
        'result_status' => 'Result Status',
        'select_result_status' => 'Select result status',
        'normal' => 'Normal',
        'abnormal' => 'Abnormal',
        'result_status_helper' => 'Select whether the test result is Normal or Abnormal',
        'upload_test_result_document' => 'Upload Test Result Document',
        'upload_document_helper' => 'Upload PDF or Word documents (max 10MB)',
        'document_name' => 'Document Name',
        'document_name_placeholder' => 'Will be auto-filled after upload',
        'uploaded_at' => 'Uploaded At',
        'no_document_uploaded' => 'No document uploaded yet',
    ],
    'doctor_opd_charge' => [
    ...
    'ipd_patient_operation' => [
        'new_operation' => 'Add Operation',
    ...
    'discharge_summary' => [
        ...
        'age' => 'Age',
        'years' => 'years',
        'admission_discharge_details' => 'Admission and Discharge Details',
        'admission_at' => 'Admission Date & Time',
        'attending_physician' => 'Attending Physician',
        'unit_room' => 'Unit / Room',
        'diagnoses' => 'Diagnoses',
        'admission_reason' => 'Primary reason for admission',
        'discharge_diagnoses' => 'Final discharge diagnoses',
        'secondary_conditions' => 'Secondary or co-existing conditions',
        'hospital_course' => 'Hospital Course',
        'procedures' => 'Procedures performed',
        'key_results' => 'Key lab or imaging results',
        'medication_plan' => 'Medication Plan',
        'new_medications' => 'New prescriptions',
        'continued_medications' => 'Continued medications',
        'discontinued_medications' => 'Discontinued drugs',
        'follow_up' => 'Follow-Up Instructions',
        'follow_up_appointments' => 'Scheduled appointments',
        'diet_activity' => 'Dietary and activity restrictions',
        'wound_care' => 'Wound care',
        'warning_signs' => 'Warning signs requiring urgent attention',
        'discharge_status' => 'Discharge Status',
        'condition' => 'Patient condition',
        'disposition' => 'Disposition',
    ],
    'ipd_patient_nurse_note' => [
        'new_note' => 'Add Nurse Note',
        'edit_note' => 'Edit Nurse Note',
        'nurse' => 'Nurse',
        'note_date' => 'Note Date',
        'note' => 'Note',
        'saved' => 'Nurse note saved successfully.',
        'updated' => 'Nurse note updated successfully.',
        'deleted' => 'Nurse note deleted successfully.',
    ],
    'ipd_oxygen_monitoring' => [
        'title' => 'Oxygen Monitoring Chart',
        'chart_description' => 'Continuous oxygen therapy observations for this admission.',
        'description' => 'Record serial SpO2, oxygen device, and flow during continuous oxygen therapy.',
        'readings' => 'Oxygen Therapy Readings',
        'new_record' => 'Add Oxygen Reading',
        'recorded_at' => 'Time Recorded',
        'spo2' => 'SpO2 (%)',
        'latest_spo2' => 'Latest SpO2',
        'delivery_device' => 'Oxygen Device',
        'flow_rate' => 'Flow Rate',
        'fio2' => 'FiO2',
        'respiratory_rate' => 'Respiratory Rate (br/min)',
        'rr_short' => 'RR',
        'target_spo2' => 'Target SpO2',
        'target_standard' => '94–98%',
        'target_copd' => '88–92%',
        'notes' => 'Notes',
        'room_air' => 'Room air',
        ...
        'empty' => 'No oxygen readings yet',
        'empty_desc' => 'Add readings while the patient is on continuous oxygen therapy.',
        'saved' => 'Oxygen reading saved successfully.',
        'updated' => 'Oxygen reading updated successfully.',
        'deleted' => 'Oxygen reading deleted successfully.',
    ],
    'ipd_patient_mar' => [
        'title' => 'Medication Administration Record (MAR)',
        'description' => 'Record medicines given to this patient.',
        'new_record' => 'Record Medication',
        'medications' => 'Medications',
        'route' => 'Route',
        'route_iv' => 'IV (Intravenous)',
        'route_im' => 'IM (Intramuscular)',
        'route_sc' => 'SC (Subcutaneous)',
        'route_po' => 'PO (Oral)',
        'route_sl' => 'SL (Sublingual)',
        ...
        'refused' => 'Refused',
        'missed' => 'Missed',
        'saved' => 'Medication administration saved successfully.',
        'updated' => 'Medication administration updated successfully.',
        'deleted' => 'Medication administration deleted successfully.',
    ],
    'charge_type' => [
        'charge_types' => 'Charge Types',
        'new_charge_type' => 'New Charge Type',
        'edit_charge_type' => 'Edit Charge Type',
        'name' => 'Charge Type',
        'saved' => 'Charge Type saved successfully.',
        'updated' => 'Charge Type updated successfully.',
        'deleted' => 'Charge Type deleted successfully.',
        'cannot_delete_default' => 'Default charge types cannot be deleted.',
    ],
    ...
    'flash' => [
        ...
        'odontogram_updated' => 'Odontogram Updated Successfully.',
        'odontogram_deleted' => 'Odontogram Deleted Successfully.',
    ],
    'purchase_medicine' => [
