...
class PathologyPermissionModuleSeeder extends Seeder
{
    public const PARENT = 'Pathology';

    public const CHILDREN = [
        'Doctor Suggested Tests',
        'Lab Report Payments',
    ];
    ...
    public function run(): void
    {
        ...
        $this->grantFromPathologyTests();
        $this->grantDefaultRoles();
    }

    private function grantFromPathologyTests(): void
    {
        $sourceModules = DB::table('modules')->where('name', 'Pathology Tests')->get();
